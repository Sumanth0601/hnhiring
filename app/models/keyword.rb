class Keyword < ActiveRecord::Base
  ...
  FINDERS = {
    ...
    location:   {
      ...
      antwerp:         -> { Comment.matching_words(%w(Antwerp)) },
      ...
      brussels:        -> { Comment.matching_words(%w(Brussels)) },
      ...
      ghent:           -> { Comment.matching_words(%w(Ghent)) },
      ...
      leuven:          -> { Comment.matching_words(%w(Leuven)) },
